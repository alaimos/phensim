...
for (i in 1:nrow(datasets)) {
    ...
    res.file  <- file.path(getwd(),"bionsi_degs",paste0("exp",id,"_result.csv"))
    res.filep <- file.path(getwd(),"bionsi_degs",paste0("exp",id,"_result_parsed.csv"))
...
saveRDS(mtx.results, file = "bionsi_degs.rds")
